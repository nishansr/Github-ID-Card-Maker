    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-center">
          ...
          <p className="text-xl font-semibold gradient-text">Loading GitHub card...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          <div className="flex flex-col items-center">
            <h3 className="text-xl font-bold gradient-text mb-4">Dark Professional</h3>
            <Card1 
              userData={userData} 
              userStats={userStats}
              qrCode={qrCodeUrl}
          ...
          <div className="flex flex-col items-center">
            <h3 className="text-xl font-bold gradient-text mb-4">Clean Modern</h3>
            <Card2 
              userData={userData} 
              userStats={userStats}
              qrCode={qrCodeUrl}
          ...
          <div className="flex flex-col items-center">
            <h3 className="text-xl font-bold gradient-text mb-4">Nature Inspired</h3>
            <Card3 
              userData={userData} 
              userStats={userStats}
              qrCode={qrCodeUrl}
